...
export class Toggl {
  ...
  private baseURL: string = "https://api.track.toggl.com/api/v9";
  private authHeadercaca: string = "";
  ...
  constructor({
    ...
    this.authHeadercaca = this.authHeader(auth);
  ...
  private authHeader(auth: Auth) {
    ...
    const authBase64 = Buffer.Buffer.from(authSecret).toString("base64");
