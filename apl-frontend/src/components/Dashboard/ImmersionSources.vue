...
import pluralize from "pluralize";
    ...
    const sortedSources = computed(() => {
        ...
        const bottomActivitiesSeconds = sort.slice(limit.value).reduce((a, b) => a + b.relativeValue, 0);
    ...
    <div class="flex bg-black 1820:h-[40rem] h-96 rounded-lg w-full ">
        ...
        <div class="flex flex-col px-10 flex-1 overflow-hidden ">
            ...
            <div class="h-20 flex flex-col justify-center w-fit ">
                <div class="font-normal tracking-wider flex items-center gap-2 text-white">
            ...
            <!-- List Section -->
            <div class=" text-white flex flex-col justify-start w-full overflow-hidden">
                <div v-for="(x, i) in sortedSources"
                    :key="x.name"
