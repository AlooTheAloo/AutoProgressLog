...
<template>
  ...
  >
    ...
    <div
      class="w-full h-36 relative rounded-xl flex items-center justify-center text-black dark:text-white border-2 border-transparent hover:border-[var(--primary-color)] transition-all duration-200"
    >
