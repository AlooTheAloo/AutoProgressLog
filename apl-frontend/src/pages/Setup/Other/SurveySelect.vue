    ...
    <div class="p-12 flex flex-col w-2/3 bg-black h-screen">
      ...
      <div class="flex flex-col flex-grow py-5 justify-start gap-2 text-left">
        ...
        <div class="font-semibold text-white text-4xl">
          Would you like to answer a few questions to help us improve
          AutoProgressLog?
        </div>
        <p class="text-sm">
          This survey is completely optional and will not collect any personal
          information. We use the data to get a sense of how AutoProgressLog is
          being used and to make improvements.
        </p>
        <div class="flex gap-2 mt-2 flex-grow"></div>
        <div class="flex justify-end gap-3">
          <Button
            ...
            label="No Thanks"
          />
          <Button @click="StartSurvey" style="width: 120px" label="Yes" />
        </div>
      </div>
    </div>
  </div>
