  ...
  <div class="flex w-screen">
    <div class="p-12 flex flex-col w-2/3 bg-black h-screen">
      ...
      <div class="flex flex-col flex-grow py-5 justify-start gap-1 text-left">
        ...
        <div class="text-sm">
          This automatic connection only works if you use Google Chrome and are
          comfortable with sharing your browser cookies with us. If you use a
          different browser or you'd rather not, please select the option to
          manually configure toggl.
        </div>
        <div class="flex flex-grow items-end justify-between">
          <div>
            <Button
              label="I'd rather do it manually"
              style="font-size: 12px; padding: 0px"
              link
              @click="ManualConnection"
            />
          </div>
          <div>
            <Button
