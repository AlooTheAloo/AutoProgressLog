    ...
    <div class=" flex w-screen">
        <div class=" p-12 flex flex-col w-2/3  bg-black h-screen">
            ...
            <div class="flex flex-col flex-grow pt-5 justify-start gap-2 text-left ">
                ...
                <div class="my-3">
                    <Button @click="OpenTogglTrackPage" icon="pi-external-link pi" label="Open toggl track profile page"/>
                </div>
                ...
                <div>
                    ...
                    <Password v-model="apiKey" fluid :feedback="false" placeholder="Enter your API token here"/>
