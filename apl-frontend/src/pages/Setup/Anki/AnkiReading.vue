  ...
  <div class="flex w-screen">
    <div class="p-12 flex flex-col w-1/2 bg-black h-screen">
      ...
      <div class="flex flex-col flex-grow py-5 gap-2 text-left">
        ...
        <p class="text-sm">
          Now that anki is connected, here are some statistics. <br />Please
          also use this opportunity to select your desired retention algorithm.
        </p>
    ...
    >
      <div
        class="w-72 h-36 bg-black rounded-xl flex items-center justify-center"
      >
      ...
      >
        ...
        <div class="flex w-4/5 justify-center h-20">
          <div class="flex-grow flex flex-col justify-center">
            <div class="font-normal tracking-wider">Retention rate</div>
            <div class="font-extrabold text-3xl">
              <div class="flex flex-row text-white">
