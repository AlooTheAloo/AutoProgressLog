  ...
  <div class="flex flex-col flex-grow py-5 text-left">
    ...
    >
      ...
      <div class="text-xs sm:text-sm lg:text-base text-[#C0C0C0] leading-relaxed">
        Now that anki is connected, here are some statistics.
        Please also use this opportunity to select your desired retention algorithm.
      </div>
    ...
    <motion.div
      ...
      :animate="{ opacity: 1, y: 0, filter: 'blur(0px)', transition: { duration: 0.6 } }"
    >
    <div class="relative w-[400px] h-[200px] bg-black rounded-[20px] flex items-center justify-center">
      ...
      <div class="flex w-4/5 justify-center h-20">
        <div class="flex-grow flex flex-col justify-center">
          <div class="font-bold text-xl text-gray-300 tracking-wider">Total Mature Cards</div>
      ...
      <div class="absolute top-0 right-0">
        ...
        <div class="flex w-4/5 justify-center h-20">
          <div class="flex-grow flex flex-col justify-center">
            <div class="font-bold text-xl text-gray-300 tracking-wider">Retention rate</div>
            <div class="font-extrabold text-3xl">
              <div class="flex flex-row text-white">
